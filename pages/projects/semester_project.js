                ...
                <div className="flex flex-col px-[10%] py-4 gap-4 h-full">
                    ...
                    <div className="flex-row lg:basis-4/6 aspect-video lg:aspect-auto flex rounded-lg overflow-hidden border-2 border-[#2F2F2F]">
                        <div className="relative flex-1">
                            <Image src="/Semester_Project.png" fill alt="TAS v2 #1" className="object-cover"></Image>
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 basis-2/6">
                        <div className="basis-1/6 bg-[#1B1B1B] rounded-lg p-2 flex flex-col border-2 border-[#2F2F2F]">
                            ...
                            <div className="flex flex-col h-full justify-around">
                                ...
                                <div className="flex flex-col gap-1">
                                    <h1 className={inter.className + " text-[#909090] text-sm pr-2"}>STARTED - 5/2023</h1>
                                    <h1 className={inter.className + " text-[#909090] text-sm pr-2"}>FINISHED - 5/2023</h1>
                                </div>
                                <div className="flex flex-row items-center">
                                ...
                                <Link href="https://github.com/RamonGarciaJr956/Semester_Project" className="flex flex-row items-center">
                        ...
                        <div className="h-full basis-5/6 bg-[#1B1B1B] rounded-lg p-2 flex flex-col border-2 border-[#2F2F2F]">
                            ...
                            <hr className='border-0 bg-[#2F2F2F] h-[2px]'></hr>
                            <p className="text-white font-thin">During the 2023 spring semester at UTRGV, my project involved designing an access control system using a server, client application, and Raspberry Pi. Users inputted a physical code via the Raspberry Pi&apos;s GPIO pins, which was transmitted to a SQL-based server for storage. The client app, developed with Beeware, requested the last entered code from the server and compared it to a known correct code to grant access.</p>
                            <br/>
                            <p className="text-white font-thin">The system comprised a reset API on a server with an SQL database for code storage. A Python script ran on the Raspberry Pi, reading the GPIO pins and sending a POST request to the server for code processing. This hands-on project enabled me to integrate various technologies, such as server-side SQL development, client-side app development with Beeware, and hardware interaction using the Raspberry Pi. It provided valuable experience in creating a secure and controlled access system that combined software and hardware components.</p>  
                        </div>
                    </div>
                </div>
            </div>
